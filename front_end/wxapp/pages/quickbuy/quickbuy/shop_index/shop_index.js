...
Page({
    ...
    onLoad: function(t) {
        ...
        i.setData({
            ...
            if (i.data.main.advs) {
                if (i.data.main.advs.length > 0) var a = [ 198 ], s = 198;
            } else var a = [ 18 ], s = 18;
            for (var o = 0; o < i.data.main.group.length; o++) i.data.main.goodsArr[i.data.main.group[o].type] && (s = s + 106 * (i.data.main.goodsArr[i.data.main.group[o].type].length ? i.data.main.goodsArr[i.data.main.group[o].type].length : .6) + 66, 
            a.push(s), i.setData({
                arrscroll: a
            }));
    ...
    addGoodToCartFn: function(t) {
        ...
        a.setData({
            ...
            addtype: "delete"
        }), "1" == t.currentTarget.dataset.more && "reduce" == a.data.addtype) s.toast(a, "请在购物车中修改多规格商品"); else if ("reduce" == a.data.addtype && t.currentTarget.dataset.min == t.currentTarget.dataset.num) s.toast(a, "不能少于" + t.currentTarget.dataset.min + "件商品"); else if ("1" == t.currentTarget.dataset.more || "0" != t.currentTarget.dataset.diyformtype || !t.currentTarget.dataset.canadd) if ("reduce" != a.data.addtype && "delete" != a.data.addtype) {
            a.setData({
                showPicker: !0,
                cycledate: !1
        ...
        "1" != t.currentTarget.dataset.more && "0" == t.currentTarget.dataset.diyformtype && t.currentTarget.dataset.canadd && (a.setData({
            storenum: t.currentTarget.dataset.store,
            maxnum: t.currentTarget.dataset.maxnum
        }), "reduce" == a.data.addtype && t.currentTarget.dataset.min == t.currentTarget.dataset.num ? s.toast(a, "不能少于" + t.currentTarget.dataset.min + "件商品") : a.addCartquick("", 1));
    },
    animate: function(t) {
        var a = this;
        a.finger = {};
    ...
    bezier: function(t, a) {
        for (var e, r, i, s = [], o = 0; o <= a; o++) {
            for (i = t.slice(0), r = []; e = i.shift(); ) if (i.length) r.push(function(t, a) {
                var e, r, i, s, o, n, d, c;
                return e = t[0], r = t[1], s = r.x - e.x, o = r.y - e.y, i = Math.pow(Math.pow(s, 2) + Math.pow(o, 2), .5), 
                n = o / s, d = Math.atan(n), c = i * a, {
                    x: e.x + c * Math.cos(d),
                    y: e.y + c * Math.sin(d)
                };
            }([ e, i[0] ], o / a)); else {
    ...
    clearShopCartFn: function(t) {
        ...
        r.get("quick/index/clearCart", {
            ...
            for (var r = a.data.tempcartid, i = [], s = 0; s < r.length; s++) console.log(r[s]), 
            i[Number(r[s])] = -1, console.log(i);
            a.setData({
                main: e,
                clickCar: !1,
                numtotal: i,
