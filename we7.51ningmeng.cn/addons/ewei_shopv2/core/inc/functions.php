...
function auth_checkauth($auth){
    ...
    $ret = cloud_upgrade(array('code' => $auth['code']));
...
function cloud_upgrade($post_data = array(),$auth, $timeout = 60)
{
    global $_W;
    load()->func('communication');
	define('HTTP_X_FOR', (isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] == '443') ? 'https://' : 'http://');
    $resp = ihttp_request(HTTP_X_FOR .'admin.zheyitianshi.com/api.php', $post_data, $timeout);
